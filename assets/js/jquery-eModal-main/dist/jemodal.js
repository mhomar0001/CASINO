    ...
    define(['jQuery'], function ($) {
        ...
        function getModalInstance() {
            ...
            function createModalElement() {
                ...
                + '   <div class=modal-header></button><h4 class=modal-title></h4></div>'
                + '  </div>'
                + ' </div>'
                + '</div>')
        ...
        function getFooter(buttons) {
            ...
            if (buttons) {
                ...
                messageFotter.append('<a href="#close-modal"rel="modal:close"><button class="x btn btn-info"  data-dismiss=modal type=button>Close</button></a>');
            }
